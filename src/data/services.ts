...
export const services: Service[] = [
  {
    ...
    description:
      "Multi-Agent-Systeme, LLM-Integration & Custom Workflows – von der Feature-Entwicklung bis zum kompletten AI-System",
    icon: "bot",
    price: "4.500 € - 45.000 €",
    ...
    examples: [
      {
        ...
        description:
          "Multi-Agent-System für automatische Reiseplanung: Email-Analyse, Destination-Matching, Itinerary-Generierung mit Hotels, Aktivitäten und PDF-Export",
      ...
      },
      {
        ...
        description:
          "LLM-basierte Extraktion strukturierter Daten aus Verträgen, Rechnungen und PDFs mit OCR und Validation",
      ...
      },
      {
        ...
        description:
          "AI-Agent für automatische Email-Klassifizierung, Antwort-Generierung und CRM-Integration",
  ...
  },
  {
    ...
    description:
      "Web Scraping, Document Parsing & Data Pipelines – von einmaligen Snapshots bis zu kontinuierlichen Datenströmen",
    icon: "database",
    ...
    examples: [
      {
        ...
        description:
          "Täglicher Crawl von 50.000+ Immobilien-Anzeigen über 20 Portale mit Preis-Tracking, Change Detection und Market Insights",
      ...
      },
      {
        ...
        description:
          "Extraktion von Vertrags-Metadaten (Parteien, Laufzeiten, Kündigungsfristen, Beträge) aus 10.000+ PDFs",
      ...
      },
      {
        ...
        description:
          "Stündliches Tracking von Konkurrenz-Preisen über 50+ Shops mit automatischen Alerts bei Preisänderungen",
  ...
  },
  {
    ...
    description:
      "Von Custom Dashboards bis zur kompletten SaaS-Plattform – Backend, Frontend, Billing, Deployment",
    icon: "layers",
    price: "5.000 € - 55.000 €",
    ...
    examples: [
      {
        ...
        description:
          "Real-time Analytics Dashboard mit Custom Charts, User Segmentation, Export-Funktionen und Role-based Access",
      ...
      },
      {
        ...
        description:
          "REST API mit 50+ Endpoints, Rate Limiting, Stripe Billing, API Keys, Developer Portal",
      ...
      },
      {
        ...
        description:
          "SaaS-Platform für Team Collaboration: Projects, Tasks, Time Tracking, Invoicing",
  ...
  },
  {
    ...
    description:
      "Von Support & Maintenance bis zu CTO-as-a-Service – kontinuierliche Entwicklung, Optimierung und strategische Beratung",
    icon: "award",
    ...
    examples: [
      {
        ...
        description:
          "Part-time Technical Leadership für Series A Startup: Tech Strategy, Hiring, Architecture Decisions, Investor Updates",
      ...
      },
      {
        ...
        description:
          "Kontinuierliche Entwicklung neuer Features, AI-Model Optimization, Performance Tuning",
      ...
      },
      {
        ...
        description:
          "Analyse bestehender Systeme, Identifikation von 12 AI Use Cases, Priorisierung & Roadmap",
