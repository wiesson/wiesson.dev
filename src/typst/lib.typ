...
// ##################
// # Print marks (crop marks) for A4 #
// ##################
#let crop-marks-a4() = {
  // Crop marks at all four corners - positioned at actual page edges
  // Using absolute positioning relative to page corners
  // Top-left corner - horizontal line extending left
  place(top + left, dx: -5mm, dy: 0mm, line(
    length: 5mm,
    stroke: 0.5pt + black
  ))
  // Top-left corner - vertical line extending up  
  place(top + left, dx: 0mm, dy: -5mm, line(
    length: 5mm,
    stroke: 0.5pt + black
  ))
  // Top-right corner - horizontal line extending right
  place(top + right, dx: 0mm, dy: 0mm, line(
    length: 5mm,
    stroke: 0.5pt + black
  ))
  // Top-right corner - vertical line extending up
  place(top + right, dx: 0mm, dy: -5mm, line(
    length: 5mm,
    stroke: 0.5pt + black
  ))
  // Bottom-left corner - horizontal line extending left
  place(bottom + left, dx: -5mm, dy: 0mm, line(
    length: 5mm,
    stroke: 0.5pt + black
  ))
  // Bottom-left corner - vertical line extending down
  place(bottom + left, dx: 0mm, dy: 0mm, line(
    length: 5mm,
    stroke: 0.5pt + black
  ))
  // Bottom-right corner - horizontal line extending right
  place(bottom + right, dx: 0mm, dy: 0mm, line(
    length: 5mm,
    stroke: 0.5pt + black
  ))
  // Bottom-right corner - vertical line extending down
  place(bottom + right, dx: 0mm, dy: 0mm, line(
    length: 5mm,
    stroke: 0.5pt + black
  ))
