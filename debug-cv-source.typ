...
#align(center)[
  ...
  #v(0.5em)
  #text(size: 10pt)[15+ Jahre Erfahrung in der Softwareentwicklung mit Fokus auf Full-Stack-Entwicklung, KI-Integration und technische Architektur]
...
#block(breakable: false)[
    #grid(
      ...
      [
        ...
        #linebreak()
        #text(size: 9pt)[Düsseldorf, Berlin]
        #v(0.3em)
...
#block(breakable: false)[
    #grid(
      ...
      [
        ...
        #linebreak()
        #text(size: 9pt)[Zürich (CH), Tuggen (CH), Remote]
        #v(0.3em)
...
#block(breakable: false)[
    #grid(
      ...
      [
        ...
        #linebreak()
        #text(size: 9pt)[Köln, Hongkong, USA (Washington DC)]
        #v(0.3em)
...
#block(breakable: false)[
    #grid(
      ...
      [
        ...
        #linebreak()
        #text(size: 9pt)[Zürich (CH), Remote]
        #v(0.3em)
...
#block(breakable: false)[
    #grid(
      ...
      [
        ...
        #text(size: 9pt)[Düsseldorf]
        #v(0.3em)
        #text(size: 9pt)[Plattform zur automatischen Überwachung von 400+ Maklern im Großraum Düsseldorf, die durch KI-gestützte Property-Extraction und tägliches Crawling manuelle Website-Checks vollständig ersetzt]
        #v(0.3em)
